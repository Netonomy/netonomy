import useCollectionStore from '@renderer/hooks/stores/useCollectionStore'
...
export function StorageWidget() {
  ...
  const fetchCollection = useCollectionStore((state) => state.actions.fetchFilesAndFolders)
